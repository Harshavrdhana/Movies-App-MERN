      ...
      <section className="flex justify-between items-center">
        ...
        <div className="flex justify-center items-center mb-[2rem] text-white">
          ...
          >
            ...
            <span className="hidden nav-item-name mt-[3rem]">Shops</span>
          </Link>
        </div>
        ...
        <div className="relative text-white">
          ...
          {dropdownOpen && userInfo && (
            <ul className={`absolute right-0 mt-2 mr-14 w-[10rem] space-y-2 bg-white text-gray-600 ${!userInfo ? "-top-20" : "-top-24"}`}>
              {userInfo.isAdmin && (
                <>
                  <li>
                    <Link
